#!/usr/bin/env python
# -*- coding: utf-8 -*-
# from https://github.com/thibaultlaugel/growingspheres/blob/master/growingspheres/utils/gs_utils.py
...
def generate_ring(center, segment, n):
    ...
    try:
        ...
        raise OverflowError(
            "Dimension too big for hyperball sampling. Please use layer_shape='sphere' instead."
        )
    r = u ** (1 / float(d))
